...
public class testVehicleType {
    ...
    static VehicleType trans;
    static MasterCallback callback;
    
    public testVehicleType(){}
    ...
    public static void setUpClass() {   
        ...
        trans = new VehicleType(instance, instance.getBranchCode(), false);
    ...
    public void test04DisplayVehicelMake(){
        try {
            ...
            for (int lnCtr = 1; lnCtr <= lnRow; lnCtr++){
                System.out.print(trans.getDetail(lnCtr, "sTypeDesc"));
                System.out.print("\t");
            }
            System.out.println("----------------------------------------");
