...
public class testCancelMaster {
    static GRider instance = new GRider();
    static CancellationMaster trans;
    static MasterCallback callback;
    
    public testCancelMaster(){}
    ...
    public static void setUpClass() {   
        ...
        trans = new CancellationMaster(instance, instance.getBranchCode(), false);
