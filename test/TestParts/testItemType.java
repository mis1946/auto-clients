...
public class testItemType {
    ...
    public static void setUpClass() {   
        ...
        trans = new PartsItemType(instance, instance.getBranchCode(), false);
...
//                trans.setMaster("sInvTypCd", "TL");
//                trans.setMaster("sDescript", "TEST LANG");
//                     
...
//        
//        assertFalse(result);
//        assertEquals("Existing Item Type Description.", trans.getMessage());
//        
//    }
    
    @Test
    public void test02OpenRecord(){
        boolean result =(trans.OpenRecord("ABCD"));
        assertTrue(result);
    }
    
    @Test
    public void test03UpdateRecordStatus(){
        boolean result =(trans.UpdateRecordStatus("ABCD",false));
        assertTrue(result);
        String psMessage;
        ...
        //psMessage = "poOriginalMaster NULL";
        
        //assertFalse(result);
        //assertEquals(psMessage, trans.getMessage());
    }
