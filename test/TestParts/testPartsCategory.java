...
public class testPartsCategory {
    static GRider instance = new GRider();
    static PartsCategory trans;
    static MasterCallback callback;
    
    public testPartsCategory(){}
    ...
    public static void setUpClass() {   
        ...
        trans = new PartsCategory(instance, instance.getBranchCode(), false);
...
//                trans.setMaster("sDescript", "TESTLANG");
//                trans.setMaster("sInvTypCd", "bp");
//                     
...
//        
////        assertFalse(result);
////        assertEquals("Existing Measure Description.", trans.getMessage());
//        
//    }
    
    @Test
    public void test02OpenRecord(){
        boolean result =(trans.OpenRecord("V00100000001"));
        assertTrue(result);
    }
    
    @Test
    public void test03UpdateRecordStatus(){
        boolean result =(trans.UpdateRecordStatus("V00100000001",true));
        assertTrue(result);
