...
public class testMeasure {
    ...
    public static void setUpClass() {   
        ...
        trans = new PartsMeasure(instance, instance.getBranchCode(), false);
    ...
    public void test01NewRecord() throws SQLException{
        ...
        if (result){
            try {
                ...
                trans.setMaster("sMeasurNm", "TESTLANG");
                trans.setMaster("sShortDsc", "LANG");
...
//        boolean result =(trans.OpenRecord("V001003"));
//        assertTrue(result);
//    }
//    
//    @Test
//    public void test03UpdateRecordStatus(){
//        boolean result =(trans.UpdateRecordStatus("V001003",true));
//        assertTrue(result);
//        
//        //assertFalse(result);
