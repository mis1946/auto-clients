...
public class testBrand {
    ...
    public static void setUpClass() {   
        ...
        trans = new PartsBrand(instance, instance.getBranchCode(), false);
    ...
    public void test01NewRecord() throws SQLException{
        ...
        if (result){
            try {
                ...
                trans.setMaster("sDescript", "LANG");
    ...
    public void test02SaveRecord(){
        ...
        //assertFalse(result);
        //assertEquals("Existing Brand Description.", trans.getMessage());
