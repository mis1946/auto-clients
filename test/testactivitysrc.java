...
public class testactivitysrc {
    static GRider instance = new GRider();
    static ActivitySource trans;
    static MasterCallback callback;
    
    public testactivitysrc(){}
    ...
    public static void setUpClass() {   
        ...
        trans = new ActivitySource(instance, instance.getBranchCode(), false);
    ...
    public void test01NewRecord() throws SQLException{
        ...
        if (result){
            try {
                ...
                trans.setMaster("sActTypDs", "TESTING");
                trans.setMaster("sEventTyp", "eve");
